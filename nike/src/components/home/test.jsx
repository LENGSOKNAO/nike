...
const HomeBanner = () => {
  ...
  return (
    <div className="">
      {/* banner bar */}
      <div className="relative xl:h-20">
      ...
      {/* banner */}
      <div
        className="overflow-hidden h-[75vh] relative  bg-white cursor-pointer"
        ref={bannerRef}
      ...
      >
        ...
        <div className="absolute bottom-5 right-2 sm:right-10 flex gap-2 items-center justify-center ">
          <button

...
const NavBar = ({ bg, text }) => {
  ...
  const styleSmallBar = "absolute top-0 right-0 bottom-0 w-85 h-screen  px-5";
  const btnHover = ` ${
    bg ? "hover:bg-black/10" : "hover:bg-gray-200"
  } p-2 rounded-4xl cursor-pointer`;
  ...
  return (
    <>
      <div className={`${isSearch ? "hidden" : "hidden lg:block"} ${text}  `}>
        <div className={`${bg ? "bg-black" : "bg-gray-200"}  px-[1%] py-2`}>
          ...
          <div className="flex items-center justify-between px-[2%] py-2">
            ...
            <div className="flex items-center gap-2 text-2xl ">
              ...
              <div className="">
                {isSearch && (
                  <>
                    <div className="absolute top-0 right-0 z-10 left-0 bg-white text-black">
                      {/* search */}
        ...
        <div className="hidden sm:hidden md:hidden lg:block">
          <div className="flex items-center justify-between px-[2%] py-2 ">
            ...
            <Link to="/" className="bg-transparent w-20">
              ...
              {bg ? (
                <img src={logoBlack} className="object-cover w-full" alt="" />
              ) : (
                <img
                  ...
                  <>
                    ...
                    >
                      ...
                      {isHoverMenu === i && (
                        <div
                          className={`${
                            bg ? "bg-[#111111]" : "bg-white"
                          } absolute top-0 left-0 right-0 z-[-1] flex justify-center py-10`}
                        >
                          <div
                                    ...
                                    {e.listSub.map((e, i) => (
                                      <div key={i}>
                                        <p
                                          className={`text-sm  ${
                                            bg
                                              ? "text-[#9e9ea0] hover:text-gray-100"
                  ...
                  <div className="absolute top-0 right-0 left-0 bg-white  overflow-y-auto">
                    ...
                    <div className="flex  justify-between px-5 py-2 ">
                      <img
                        ...
                        alt=""
                      />
                      <div className="flex w-[60%] flex-col items-center justify-center text-black pt-2">
                        <div className="flex w-full items-center bg-black/3 hover:bg-black/5  rounded-full">
                          <div className="p-2 bg-black/3 hover:bg-black/10 cursor-pointer rounded-full">
                            <CiSearch />
                          </div>
                      ...
                      <span
                        onClick={closeSearch}
                        className="text-lg text-black font-medium cursor-pointer py-1"
                      >
                        Concel
                      </span>
                    </div>
